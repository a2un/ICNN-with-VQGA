...
class DecoderRNN(nn.Module):
    ...
    def forward(self, layer_features, captions, lengths):
        ...
        layer_features = [pad(l,(m-l.size(),0,m-l.size(),0)) for l in layer_features if l.size(0) < m else l]
        layer_features = [pad(l,(0,m-l.size(),0,m-l.size())) for l in layer_features if l.size(1) < m else l]
